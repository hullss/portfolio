  ...
  const packs = {
    sk: {
      ...
      text: {
        ...
        "#projects .project-card:nth-child(1) .private-note": "Súkromný tímový repozitár",
        ...
        "#projects .project-card:nth-child(3) > div:nth-child(2) > p": "Desktopová aplikácia v JavaFX a REST backend v Spring Boote s kompletným návrhom ER/EER schémy, MySQL/HikariCP a viacmodulovou štruktúrou Maven.",
        "#projects .project-card:nth-child(4) > div:nth-child(2) > p": "Produktívna aplikácia s ukladaním do MySQL a testovacím stackom pokrývajúcim jednotkové aj integračné scenáre.",
        "#projects .project-card:nth-child(5) .project-kicker": "2. miesto · univerzitný hackathon",
        "#projects .project-card:nth-child(5) > div:nth-child(2) > p:not(.project-kicker)": "Pomocník pri nákupe potravín využívajúci pandas na spracovanie dát a Google Gemini API na tvorbu inteligentnejších odporúčaní.",
        "#projects .project-card:nth-child(6) > div:nth-child(2) > p": "Desktopová hra v Jave s generovaním hlavolamov a ukladaním a načítaním vo formáte CSV.",
      ...
      html: {
        ...
        "#projects .project-card:nth-child(1) .project-actions a": "Prípadová štúdia <span>→</span>",
        ...
        "#projects .project-card:nth-child(3) .project-actions a": "Zdrojový kód <span>↗</span>",
        "#projects .project-card:nth-child(4) .project-actions a": "Zdrojový kód <span>↗</span>",
    ...
    uk: {
      ...
      text: {
        ...
        "#projects .project-card:nth-child(1) .private-note": "Приватний командний репозиторій",
        ...
        "#projects .project-card:nth-child(3) > div:nth-child(2) > p": "Настільний застосунок JavaFX і REST backend на Spring Boot із повним проєктуванням ER/EER-схеми, MySQL/HikariCP та багатомодульною структурою Maven.",
        "#projects .project-card:nth-child(4) > div:nth-child(2) > p": "Застосунок для продуктивності зі збереженням у MySQL і тестовим стеком для модульних та інтеграційних сценаріїв.",
        "#projects .project-card:nth-child(5) .project-kicker": "2 місце · університетський хакатон",
        "#projects .project-card:nth-child(5) > div:nth-child(2) > p:not(.project-kicker)": "Помічник для купівлі продуктів, який використовує pandas для обробки даних і Google Gemini API для створення розумніших рекомендацій.",
        "#projects .project-card:nth-child(6) > div:nth-child(2) > p": "Настільна гра на Java з генерацією головоломок і збереженням та завантаженням у форматі CSV.",
      ...
      html: {
        ...
        "#projects .project-card:nth-child(1) .project-actions a": "Переглянути кейс <span>→</span>",
        ...
        "#projects .project-card:nth-child(3) .project-actions a": "Переглянути код <span>↗</span>",
        "#projects .project-card:nth-child(4) .project-actions a": "Переглянути код <span>↗</span>",
