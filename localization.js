  ...
  const packs = {
    sk: {
      ...
      text: {
        ...
        "#projects .project-card:nth-child(4) > div:nth-child(2) > p": "Desktopová aplikácia v JavaFX a REST backend v Spring Boote s kompletným návrhom ER/EER schémy, MySQL/HikariCP a viacmodulovou štruktúrou Maven.",
        "#projects .project-card:nth-child(5) > div:nth-child(2) > p": "Produktívna aplikácia s ukladaním do MySQL a testovacím stackom pokrývajúcim jednotkové aj integračné scenáre.",
    ...
    uk: {
      ...
      text: {
        ...
        "#projects .project-card:nth-child(4) > div:nth-child(2) > p": "Настільний застосунок JavaFX і REST backend на Spring Boot із повним проєктуванням ER/EER-схеми, MySQL/HikariCP та багатомодульною структурою Maven.",
        "#projects .project-card:nth-child(5) > div:nth-child(2) > p": "Застосунок для продуктивності зі збереженням у MySQL і тестовим стеком для модульних та інтеграційних сценаріїв.",
